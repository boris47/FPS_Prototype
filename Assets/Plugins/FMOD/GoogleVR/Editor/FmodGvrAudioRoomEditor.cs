...
[CustomEditor(typeof(FmodGvrAudioRoom))]
[CanEditMultipleObjects]
public class FmodGvrAudioRoomEditor : Editor {
  ...
  public override void OnInspectorGUI () {
    ...
    EditorGUILayout.Slider(reflectivity, 0.0f, FmodGvrAudio.maxReflectivity, reflectivityLabel);

    EditorGUILayout.Separator();

    EditorGUILayout.LabelField(reverbPropertiesLabel);
    ++EditorGUI.indentLevel;
    EditorGUILayout.Slider(reverbGainDb, FmodGvrAudio.minGainDb, FmodGvrAudio.maxGainDb,
                           reverbGainLabel);
    EditorGUILayout.Slider(reverbBrightness, FmodGvrAudio.minReverbBrightness,
                           FmodGvrAudio.maxReverbBrightness, reverbBrightnessLabel);
    EditorGUILayout.Slider(reverbTime, 0.0f, FmodGvrAudio.maxReverbTime, reverbTimeLabel);
    --EditorGUI.indentLevel;
