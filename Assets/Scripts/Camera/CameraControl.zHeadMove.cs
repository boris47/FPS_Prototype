...
//		fAmplitude		*= ( 5.0f - ( fStamina * 4.0f ) );
		...
		float deltaXBase = Mathf.Sin( m_ThetaX ) * fAmplitude * m_AmplitudeVert * m_InternalWeight;
		float deltaYBase = Mathf.Cos( m_ThetaY ) * fAmplitude * m_AmplitudeHoriz * m_InternalWeight;
