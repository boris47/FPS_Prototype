...
public abstract partial class Walker {
	...
	protected partial class Walker_AI_Beaviour_Seeker {
		...
		public		override	void		OnFrame( float DeltaTime )
		{
			...
			if ( m_ThisEntity.m_HasDestination && m_ThisEntity.m_IsAllignedHeadToPoint )
			{
				...
				Vector3 projectedPoint = Utils.Math.ProjectPointOnPlane( m_ThisEntity.m_GunTransform.up, m_ThisEntity.m_GunTransform.position, m_ThisEntity.m_PointToLookAt );
		...
		public		override	void		OnDestinationReached( Vector3 Destination )
		{
			...
			m_ThisEntity.SetPointToLookAt( m_ThisEntity.m_HeadTransform.position + m_ThisEntity.transform.forward );

			m_ThisEntity.ChangeState( BrainState.NORMAL );
		}
