...
//		m_ObjectsPool = new List<T>((int)constructorData.Size);
	...
	//////////////////////////////////////////////////////////////////////////
	private static IEnumerator AsyncDestroyChildren(Transform t, int StartIndex = 0, int EndIndex = int.MaxValue)
	{
		...
		for (int i = EndIndex - 1; i >= StartIndex; i--)
		{
			...
			Utils.CustomAssertions.IsNotNull(child);
	...
	public bool Convert(GameObject model, System.Action<T> actionOnObject = null)
	{
		...
		CoroutinesManager.Start(AsyncDestroyChildren(m_ContainerGO.transform));
	...
	{
		T result = default;
		if (Utils.CustomAssertions.IsNotNull(model))
		{
		...
		Utils.CustomAssertions.IsNotNull(result);
		return result;
	}
