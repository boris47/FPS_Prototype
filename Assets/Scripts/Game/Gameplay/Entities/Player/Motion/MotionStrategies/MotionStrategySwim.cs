...
namespace Entities.Player.Components
{
	...
	[Configurable(nameof(m_Configs), "Player/MotionStrategies/" + nameof(MotionStrategySwim))]
	public class MotionStrategySwim : MotionStrategyBase
	{
		[SerializeField, ReadOnly]
		private				Configuration_Swim				m_Configs					= null;
