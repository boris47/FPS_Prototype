...
namespace Entities.Player.Components
{
	...
	[Configurable(nameof(m_Configs), "Player/MotionStrategies/" + nameof(MotionStrategyClimb))]
	public class MotionStrategyClimb : MotionStrategyBase
	{
		[SerializeField, ReadOnly]
		private				Configuration_Climb				m_Configs					= null;
		...
		private void OnSprintStart() => m_CurrentMovementMultiplier += m_Configs.SprintMult;
		private void OnSprintEnd() => m_CurrentMovementMultiplier -= m_Configs.SprintMult;
