...
namespace Entities.AI.Components.Behaviours
{
	internal static class Extensions
	{
		...
		public static NodeViewBase GetModeViewBase(this Port port) => port.node.GetAsBTNodeView();
		public static BTNode GetBTNode(this Port port) => port.GetBTNodePort().Node;
	}

	public static class BehaviourTreeEditorUtils
	{
		public static T GetInstancePropertyValue<T>(System.Type type, string propertyName)
		{
			T result = default;
			try
			{
				...
				result = (T)propertyInfo.GetGetMethod().Invoke(instance, null);
			}
