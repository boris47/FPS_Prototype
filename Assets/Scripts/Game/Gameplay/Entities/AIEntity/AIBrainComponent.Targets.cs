...
namespace Entities.AI.Components
{
	...
	internal interface IBrainTargets
	{
		...
		EntityFaction[] GetEnemyFactions();
	...
	public partial class AIBrainComponent : AIEntityComponent, IBrainTargets
	{
		...
		EntityFaction[] IBrainTargets.GetEnemyFactions() => RelationsBoard.Instance.GetAllFactionsWithRelation(m_Owner, EFactionRelationType.Enemy);
