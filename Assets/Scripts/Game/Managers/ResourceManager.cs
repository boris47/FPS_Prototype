...
public sealed class ResourceManager : GlobalMonoBehaviourSingleton<ResourceManager>
{
	/// <summary> Class that contains the loaded asset, if load succeeded </summary>
	...
	/////////////////////////////////////////////////////////////////
	public static string ConcatenatePath(params string[] InPaths)
	{
		...
		static string AggregateFunc(string InPath1, string InPath2)
		{
			return InPath1.TrimEnd(System.IO.Path.DirectorySeparatorChar, System.IO.Path.AltDirectorySeparatorChar)
			+ '/'
			+ InPath2.TrimStart(System.IO.Path.DirectorySeparatorChar, System.IO.Path.AltDirectorySeparatorChar);
		}
		return InPaths.Aggregate(InPaths[0], AggregateFunc);
	}
